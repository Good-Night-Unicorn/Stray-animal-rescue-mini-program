        ...
        <form class="app-update-pv">
			<view
                ...
                <textarea
                        ...
                        v-model='ruleForm.chongwuLiuyanText' placeholder="留言内容"></textarea>
            </view>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`chongwuLiuyan`, this.ruleForm.id);
        ...
        methods: {
            ...
            async onSubmitTap() {
			if ((!this.ruleForm.chongwuLiuyanText)) {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`chongwuLiuyan`, this.ruleForm);
                } else {
                    await this.$api.save(`chongwuLiuyan`, this.ruleForm);
                }
