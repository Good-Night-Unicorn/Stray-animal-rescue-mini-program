<template>
    <view class="content">
        <view class="box"
              :style='{"padding":"48rpx","boxShadow":"0 0 0px 20rpx var(--publicMainColor)","margin":"60rpx auto","backgroundColor":"var(--publicSubColor)","borderColor":"rgba(255, 255, 255, 1)","borderRadius":"60rpx","borderWidth":"40rpx 40rpx 40rpx","width":"90%","borderStyle":"solid","height":"auto"}'>
            ...
            <button class="landing"
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"rgba(180, 153, 80, 0)","borderRadius":"40rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"4rpx","width":"40%","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}'
