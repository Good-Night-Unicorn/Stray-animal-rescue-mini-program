<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <view v-if="isAuth('dictionary','报表')" @tap="openChartDialog" :style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
                报表
            </view>
	...
	<view style="">
        <view style="padding: 0 20rpx;width: 100%;margin: 0 auto;;flex-direction: column;flex-wrap: wrap;flex-direction: row;margin-top: 0upx;">
            ...
            <view style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;font-size: 24rpx;color: #8799A3;">
                ...
                <uni-icons v-show="isAuth('dictionary','回复')" @tap="onReply(item.id)" type="chat-filled" size="20">
                </uni-icons>
		...
		methods: {
            ...
            async chartDialog() {
                ...
                let res = await _this.$api.requestConditionDataGet("",'newSelectGroupSum',null,{
                    tableName:'dictionary_shouzhi',
                    groupColumn:'dictionary_types',
                    // sumColumn:'dictionary_number',
