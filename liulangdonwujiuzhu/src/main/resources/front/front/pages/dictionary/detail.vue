	...
	<script>
		export default {
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.detail('dictionary', this.dictionaryId);
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
                                ...
                                // uni.setStorageSync('dictionaryId', _this.dictionaryId);
                                // _this.$utils.jump('/pages/dictionaryYuyue/add-or-update');
