...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <block v-for="(item,index) in newsList" :key="index">
        <view @tap="onDetailTap('news',item.id)" v-if="index==0" class="list-item"
            ...
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,255,255,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" class="listmpic" :src="baseUrl+item.newsPhoto"></image>
        ...
        <view @tap="onDetailTap('news',item.id)" v-if="index>0" class="list-item"
              :style='{"padding":"0 20rpx","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"20rpx 0 0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,255,255,1)","borderRadius":"0","borderWidth":"20rpx 8rpx 8rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
            <view
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view class="right-content" @tap="onPageTap('chongwu')" :style="{fontSize:'32rpx',color:'#FFF'}">
        查看更多
    </view>
</view>
<view v-if='2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''" :style='{"borderRadius":"0","backgroundColor":"#efefef"}'>
    <view @tap="onDetailTap('chongwu',product.id)" :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' class="uni-product" v-for="(product,index) in chongwuList" :key="index">
        <view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}' class="uni-product-title">{{product.chongwuName}}</view>
        <view class="image-view" :style='{"borderRadius":"2rpx","height":"180rpx"}'>
            <image :style='{"height":"180rpx","borderRadius":"90rpx"}' mode="aspectFill" class="uni-product-image" :src="baseUrl+product.chongwuPhoto"></image>
        </view>
    </view>
</view>
        </view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view class="right-content" @tap="onPageTap('dongwu')" :style="{fontSize:'32rpx',color:'#FFF'}">
        查看更多
    </view>
</view>
<view v-if='2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''" :style='{"borderRadius":"0","backgroundColor":"#efefef"}'>
    <view @tap="onDetailTap('dongwu',product.id)" :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' class="uni-product" v-for="(product,index) in dongwuList" :key="index">
        <view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}' class="uni-product-title">{{product.dongwuName}}</view>
        <view class="image-view" :style='{"borderRadius":"2rpx","height":"180rpx"}'>
            <image :style='{"height":"180rpx","borderRadius":"90rpx"}' mode="aspectFill" class="uni-product-image" :src="baseUrl+product.dongwuPhoto"></image>
        </view>
    </view>
</view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            // let news = await this.$api.requestCondition('news','gexingtuijian',newsVal);
            ...
            let chongwu = await this.$api.requestCondition('chongwu','gexingtuijian',chongwuVal);

            this.chongwuList = chongwu.data.list
            this.chongwuList.forEach(function(item, index) {
                if(item.chongwuContent != null && item.chongwuContent != "" && item.chongwuContent != "null"){
                    item.chongwuContent =item.chongwuContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
            ...
            let dongwu = await this.$api.requestCondition('dongwu','gexingtuijian',dongwuVal);

            this.dongwuList = dongwu.data.list
            this.dongwuList.forEach(function(item, index) {
                if(item.dongwuContent != null && item.dongwuContent != "" && item.dongwuContent != "null"){
                    item.dongwuContent =item.dongwuContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
