<template>
    <view class="content">
        <view class="box"
              :style='{"padding":"48rpx","boxShadow":"0 0px 0px 20rpx var(--publicMainColor)","margin":"60rpx auto","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"var(--publicSubColor)","borderRadius":"60rpx","borderWidth":"40rpx 40rpx 40rpx","width":"90%","borderStyle":"solid","height":"auto"}'>
            <view class="logo">
                <!-- 				:style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 24rpx","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
                 -->				<image
                    ...
                    src='http://localhost:8080/liulangdonwujiuzhu/img/logo.jpg' mode="aspectFill">
            </image>
            </view>
            ...
            <view>
                <button @tap="register" type="primary"
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"rgba(180, 153, 80, 0)","borderRadius":"40rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"4rpx","width":"40%","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}'>注册</button>
            </view>
        </view>
    </view>
</template>
