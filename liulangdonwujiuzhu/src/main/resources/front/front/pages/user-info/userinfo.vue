<template>
	<view class="content">
        <view class="box"
              :style='{"padding":"38rpx","boxShadow":"0 0px 0px 20rpx var(--publicMainColor)","margin":"60rpx auto","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"var(--publicSubColor)","borderRadius":"60rpx","borderWidth":"40rpx 40rpx 40rpx","width":"90%","borderStyle":"solid","height":"auto"}'>
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'>用户名称
			 </view>
			 <input
					:style='{"padding":"0 30rpx","boxShadow":"0 8rpx 0px 4rpx var(--publicMainColor)","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
					v-model="ruleForm.yonghuName" placeholder="用户名称"></input>
		 </view>
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			...
			<view v-if="tableName=='yonghu'" class="cu-form-group select">
				...
				<picker @change="yonghusexTypesChange" :value="sexTypesIndex" :range="sexTypesOptions" range-key="indexName">
					<view :style='{"padding":"0 30rpx","boxShadow":"0 8rpx 0px 4rpx var(--publicMainColor)","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
