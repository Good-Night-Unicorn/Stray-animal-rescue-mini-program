        ...
        <form class="app-update-pv">
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">寻宠</view>
                    <picker @change="chongwuChange" :value="chongwuIndex" :range="chongwuOptions" range-key="chongwuName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.chongwuId?ruleForm.chongwuName:"请选择寻宠"}}</view>
                    </picker>
                </view>-->
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">类型</view>
                    <picker @change="chongwuCollectionTypesChange" :value="chongwuCollectionTypesIndex" :range="chongwuCollectionTypesOptions" range-key="indexName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.chongwuCollectionTypes?ruleForm.chongwuCollectionValue:"请选择类型"}}</view>
                    </picker>
                </view>
...
<script>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            let chongwuData = await this.$api.page(`chongwu`, chongwuParams);
            this.chongwuOptions = chongwuData.data.list;
            let yonghuParams = {
                page: 1,
                limit: 100,
            }
		...
		/*下拉框*/
			let chongwuCollectionTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'chongwu_collection_types',
            }
			let chongwuCollectionTypes = await this.$api.page(`dictionary`, chongwuCollectionTypesParams);
			this.chongwuCollectionTypesOptions = chongwuCollectionTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`chongwuCollection`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.chongwuCollectionId){
                this.ruleForm.chongwuCollectionId = options.chongwuCollectionId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            // 下拉变化
            chongwuCollectionTypesChange(e) {
            ...
            async onSubmitTap() {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`chongwuCollection`, this.ruleForm);
                } else {
                    await this.$api.save(`chongwuCollection`, this.ruleForm);
                }
