        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '寻宠标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.chongwuName" placeholder="寻宠标题" clearable></el-input>
                     </el-form-item>
                                         
                     <el-form-item :label="contents.inputTitle == 1 ? '寻宠类型' : ''">
                        <el-select v-model="searchForm.chongwuTypes" placeholder="请选择寻宠类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/liulangdonwujiuzhu/upload/chongwuMuBan.xls"
                        >批量导入寻宠数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('chongwu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="chongwuPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.chongwuPhoto">
                                <img :src="$base.url+scope.row.chongwuPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="chongwuClicknum"
                                      header-align="center"
                                      label="寻宠热度">
                        <template slot-scope="scope">
                            {{scope.row.chongwuClicknum}}
                        </template>
                    </el-table-column>
