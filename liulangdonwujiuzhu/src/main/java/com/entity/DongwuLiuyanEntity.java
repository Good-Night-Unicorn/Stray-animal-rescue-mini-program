...
public class DongwuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public DongwuLiuyanEntity() {

	}

	public DongwuLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "dongwu_liuyan_text")

    private String dongwuLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getDongwuLiuyanText() {
        return dongwuLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setDongwuLiuyanText(String dongwuLiuyanText) {
        this.dongwuLiuyanText = dongwuLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
    ...
    public String toString() {
        return "DongwuLiuyan{" +
            ...
            ", dongwuId=" + dongwuId +
            ", yonghuId=" + yonghuId +
            ", dongwuLiuyanText=" + dongwuLiuyanText +
