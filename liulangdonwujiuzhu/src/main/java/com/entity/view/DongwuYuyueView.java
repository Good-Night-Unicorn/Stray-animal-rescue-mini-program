...
public class DongwuYuyueView extends DongwuYuyueEntity implements Serializable {
	...
	*/
	...
	private String dongwuYuyueYesnoValue;
	...
	public DongwuYuyueView() {

	}

	public DongwuYuyueView(DongwuYuyueEntity dongwuYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, dongwuYuyueEntity);
	...
	* 获取： 审核状态的值
	*/
	public String getDongwuYuyueYesnoValue() {
		return dongwuYuyueYesnoValue;
	}
	/**
	* 设置： 审核状态的值
	*/
	public void setDongwuYuyueYesnoValue(String dongwuYuyueYesnoValue) {
		this.dongwuYuyueYesnoValue = dongwuYuyueYesnoValue;
	}
	...
	public String toString() {
		return "DongwuYuyueView{" +
			", dongwuYuyueYesnoValue=" + dongwuYuyueYesnoValue +
