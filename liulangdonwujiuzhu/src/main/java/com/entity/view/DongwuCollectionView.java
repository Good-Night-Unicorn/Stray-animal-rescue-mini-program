...
public class DongwuCollectionView extends DongwuCollectionEntity implements Serializable {
	...
	*/
	...
	private String dongwuCollectionValue;
	...
	public DongwuCollectionView() {

	}

	public DongwuCollectionView(DongwuCollectionEntity dongwuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, dongwuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getDongwuCollectionValue() {
		return dongwuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setDongwuCollectionValue(String dongwuCollectionValue) {
		this.dongwuCollectionValue = dongwuCollectionValue;
	}
	...
	public String toString() {
		return "DongwuCollectionView{" +
			", dongwuCollectionValue=" + dongwuCollectionValue +
